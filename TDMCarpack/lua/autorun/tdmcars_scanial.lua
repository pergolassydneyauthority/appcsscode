local V = {
			...
			VC_Lights = { //Pos can be a simple Vector() relative to the vehicle or an attachment name, else is self explanatory, can be an infinite amount of these.
						...
						{Pos = Vector(51.5, 110.8, 36.2), Mat = "sprites/glow1.vmt", Alpha = 210, Size = 0.8, DynLight = true, BlinkersColor = "255 130 0"},
						{Pos = Vector(-51.5, 110.8, 36.2), Mat = "sprites/glow1.vmt", Alpha = 210, Size = 0.8, DynLight = true, BlinkersColor = "255 130 0"},
						{Pos = Vector(43.8, 116.8, 36.4), Mat = "sprites/glow1.vmt", Alpha = 180, Size = 1, DynLight = false, NormalColor = "255 255 255"},
						{Pos = Vector(-41.2, 116.8, 36.4), Mat = "sprites/glow1.vmt", Alpha = 180, Size = 1, DynLight = false, NormalColor = "255 255 255"},
						{Pos = Vector(44, 114.8, 28.5), Mat = "sprites/glow1.vmt", Alpha = 180, Size = 0.5, DynLight = false, NormalColor = "255 255 255"},
						{Pos = Vector(-41.5, 114.8, 28.5), Mat = "sprites/glow1.vmt", Alpha = 180, Size = 0.5, DynLight = false, NormalColor = "255 255 255"},
						{Pos = Vector(37, 118, 28.5), Mat = "sprites/glow1.vmt", Alpha = 180, Size = 0.5, DynLight = false, NormalColor = "255 255 255"},
						{Pos = Vector(-34.5, 118, 28.5), Mat = "sprites/glow1.vmt", Alpha = 180, Size = 0.5, DynLight = false, NormalColor = "255 255 255"},
						{Pos = Vector(37.3, 115.3, 122.7), Mat = "sprites/glow1.vmt", Alpha = 180, Size = 0.2, DynLight = false, NormalColor = "255 255 255"},
						...
						{Pos = Vector(-34.8, 115.3, 122.7), Mat = "sprites/glow1.vmt", Alpha = 180, Size = 0.2, DynLight = false, NormalColor = "255 255 255"},
						{Pos = Vector(20.1, 116.6, 122.8), Mat = "sprites/glow1.vmt", Alpha = 180, Size = 1, DynLight = false, NormalColor = "255 255 255"},
						{Pos = Vector(-17.6, 116.6, 122.8), Mat = "sprites/glow1.vmt", Alpha = 180, Size = 1, DynLight = false, NormalColor = "255 255 255"},
						{Pos = Vector(37, 115.3, 36.5), Size = 1.2, GlowSize = 1, HeadLightAngle = Angle(-5, 85, 0)},
						{Pos = Vector(-36.5, 115.3, 36.5), Size = 1.2, GlowSize = 1, HeadLightAngle = Angle(-5, 95, 0)}
						},
			...
			//
				KeyValues = {
							vehiclescript	=	"scripts/vehicles/TDMCars/scania_l.txt"
							}
			}
list.Set("Vehicles", "scanialtdm", V)