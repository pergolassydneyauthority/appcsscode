local V = {
			...
			VC_AttachPos = Vector(1.5, -72, 50), //An attachment name or a simple Vector(0,-70,56), relative to the vehicle.
			...
			//
				KeyValues = {
							vehiclescript	=	"scripts/vehicles/TDMCars/scania_h.txt"
							}
			}
list.Set("Vehicles", "scaniahtdm", V)